<template>
  <div class="centered-container">
    <md-content class="md-elevation-3 formdata">
      <div class="title">
...
export default {
  ...
  methods: {
    submitForm() {
      ...
      // Simulate an asynchronous operation, for example, a request to a server
      setTimeout(() => {
        // Assuming the operation is completed after 2 seconds
        console.log("Operation completed");
        this.$router.push("/users");
        this.loading = false; // Set loading back to false after the operation is completed
      }, 2000);
    },
  },
};
